...
import { IconEdit, IconTrash, IconUserX } from "../../../components/shared/icons";

export default function TripOverflowSheet({ isOwner, onEdit, onDelete, onLeave, onClose }: {
  isOwner?: boolean; onEdit: () => void; onDelete: () => void; onLeave: () => void; onClose: () => void;
}) {
  return (
      ...
      <div className="px-3 py-3 space-y-0.5">
        ...
        {!isOwner && (
          ...
          >
            ...
            <div>
              <p className="text-[15px] font-600 text-[#DC2626]">Leave trip</p>
              <p className="text-[12px] font-500 text-[#94A3B8] mt-0.5">You can rejoin later</p>
            </div>
          </button>
        )}
        {isOwner && (
